...
import { FaSearch, FaFilter, FaMapMarkerAlt, FaStore, FaTags, FaUser, FaCog } from 'react-icons/fa';
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        ...
        setError('İşletmeler yüklenirken bir hata oluştu. Lütfen sayfayı yenileyin.');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="relative container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Yerel işletmeleri keşfedin ve destekleyin
            </p>
        ...
        {filteredBusinesses.length === 0 && (
          <div className="text-center py-16 bg-gray-800/80 backdrop-blur-lg rounded-3xl shadow-xl border border-gray-700">
            ...
            <p className="text-gray-400 max-w-md mx-auto">
              Aradığınız kriterlere uygun işletme bulunamadı. Lütfen farklı bir arama yapın.
            </p>
          </div>
        )}
      </div>
